...
//Escribe tu código aquí
for (let fila in programmers) {
  console.log(
    programmers[fila]["name"] +
      " " +
      programmers[fila]["lastname"] +
      ", " +
      programmers[fila]["knowledge"],
  );
}
...
while (indice < 5) {
  console.log("Hola, mi nombre es", names[indice]);
  indice++;
}
